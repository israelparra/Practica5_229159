    ...
    fun agregarProductos(option:String?){
        ...
        when(option){
            ...
            "Combinations"->{
                ...
                menu.add(Product("Traditional Taco Combo",R.drawable.taco,"Tortilla de Maiz, tu carne favorita, servido con arroz y frijoles Corn tortilla taco, your choice of meat, served with rice and beans.", 6.99))
            ...
            "Tortas"->{
                ...
                menu.add(Product("Torta cubana", R.drawable.tortacubana,"Chorizo, asada, jamon, pastor y queso Mexican sausage, steak, marinated pork, ham, and cheese", 12.49))
            ...
            "Sopas"->{
                ...
                menu.add(Product("Caldo de res", R.drawable.caldores, "Tamaño", 5.99))
                ...
                menu.add(Product("Coctel camaron", R.drawable.coctel, "Shrimp koktail", 14.99))
            }
            "Drinks"->{
                imgA.setImageResource(R.drawable.drinks)
                menu.add(Product("Sodas", R.drawable.sodas, "", 2.99))
                menu.add(Product("Jarritos", R.drawable.jarritos, "", 2.35))
                menu.add(Product("Aguuas frescas", R.drawable.sodas, "", 2.35))
                ...
                menu.add(Product("Lata Beer", R.drawable.sodas, "", 2.99))
                menu.add(Product("Charolazo", R.drawable.charolazo, "", 15.75))
                menu.add(Product("Charolazo con camarones", R.drawable.charolazo, "", 21.99))
                menu.add(Product("La mamalona", R.drawable.michelada, "", 12.99))
                menu.add(Product("La mamalona con camarones", R.drawable.michelada, "", 14.99))
                menu.add(Product("Cubetazo (6 cervezas)",R.drawable.cubetazo, "", 21.99))
            }
